                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="display" id="display" class="form-control select2">
                                            ...
                                            @foreach ($displays as $display)
                                                <option {{ old('display', $schedule->display_id) == $display->id ? 'selected' : '' }}
                                                    value="{{ $display->id }}">
                                                    {{ $display->name }}</option>
                                            @endforeach
                                        </select>
...
@section('js')
    <script>
        ...
        if(schedule['promotion_id'] == null){
            $('#event_promotion_type').val('Event').change();
            $('#event_promotion').val(schedule['event_id']).change();
        } else{
            $('#event_promotion_type').val('Promotion').change();
            $('#event_promotion').val(schedule['promotion_id']).change();
        }
    </script>
@endsection
