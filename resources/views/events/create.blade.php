                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name"
                                            placeholder="ex: Rapat Direksi PT ABC" value="{{ old('name') }}" required>
                                    </div>
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label>Participant Name</label>
                                        <input type="text" id="participant_name" class="form-control"
                                            name="participant_name" placeholder="ex: PT ABC"
